...
public class MenuDao extends SqlSessionDaoSupport{
	private static ILogger log = new ILogger(ApiConstants.JST_BASE, UserDao.class);

    @Override
    public void setSqlSessionFactory(SqlSessionFactory menuSqlSessionFactory) {
        super.setSqlSessionFactory(menuSqlSessionFactory);
    }
