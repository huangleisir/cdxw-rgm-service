...
public class WxdcDao extends SqlSessionDaoSupport {
    private static ILogger log = new ILogger(ApiConstants.JST_BASE, WxdcDao.class);

    
    @Override
    public void setSqlSessionFactory(SqlSessionFactory wxdcSqlSessionFactory) {
        super.setSqlSessionFactory(wxdcSqlSessionFactory);
      }
