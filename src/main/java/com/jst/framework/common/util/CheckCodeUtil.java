 ...
 * 
 * 
 * @Package: com.jst.mgr.portal.common.util  
 * @ClassName: CheckCodeUtil 
 * @Description: 校验数工具类
 *
 * @author: lixin 
 * @date: 2016年12月30日 下午4:36:23 
 * @version V1.0
 */
public final class CheckCodeUtil {
     ...
     * Logger.
     */
//    private static final Logger logger = Logger.getLogger(CheckCodeUtil.class);
